    ...
    if (!authLoading && user) {
      ...
      Promise.all([
        ...
        ordersSnap.forEach(doc => {
          ...
          if (order.orderStatus !== 'cancelled' && order.orderStatus !== 'pending' && order.orderStatus !== 'failed') {totalOrders++;}          
        ...
        ordersSnap.forEach(doc => {
          ...
          if (createdAt >= start && createdAt < end) {
            ...
            if (!['cancelled', 'pending','failed'].includes(order.orderStatus)) {
        ...
        const allNonCancelledOrders = ordersSnap.docs
          .map(doc => doc.data())
          .filter(order => !['cancelled', 'pending'].includes(order.orderStatus));
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <h1 className="text-3xl font-bold text-gray-900">
            Advanced Analytics Over the Fixed Time Interval
          </h1>
